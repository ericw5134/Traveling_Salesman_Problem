...
{
  protected: 
    // children of the class can access the protected data fields
  ...
  public:
    ...
    // I made this function myself to be used in solve()
    // remove a point from the vector with the given name
    void remove(Point& pt, string name);
